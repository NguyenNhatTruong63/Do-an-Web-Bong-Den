...
//            ps.setInt(1, id);
    ...
    public void signup (String userName, String password, String repassword, String email, String phoneNumer){
...
////        }
//        List<Product> list = dao.searchbyname("BÃ³ng ÄÃ¨n Buld Ráº¡ng ÄÃ´ng 12W");
//        for (Product product: list){
//            System.out.println(product);
//        }
//
