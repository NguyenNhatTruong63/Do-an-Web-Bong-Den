                ...
                <div class="container">
                    <div class="detail_product">
                        <div class="product_alpha">
                            <a><img class="alpha_img" src="assart/image/san_pham_tc/sp1_den-led-am-tran-18w-panasonic.jpg">
                    ...
                    <div id="section_detail" class="">
                        <div class="container">
                            ...
                            <div class="detail_infor1">
                                ...
                                <table class="detail" border="1px" cellpadding="2px" cellspacing="2px" >
                                    <caption class="text_title">Sản Phẩm Đèn Led ốp trần nổi Panasonic 18W</caption>
                                    <tr class="feature">
                                        <td>Đặc tính của đèn</td>
                                        <td> Nguồn điện: 220V</td>
                                        <td> Kích thước: (55x100)mm</td>
                                        <td> Vật Liệu: Nhựa</td>
                                    </tr>
                                    <tr class="parameters">
                                        <td> Thông số điện</td>
                                        <td> Công suất: </td>
                                        <td>Điện áp có thể hoạt động: 150V-250V</td>
                                        <td>Hệ số công suất: 0.5</td>

                                    </tr>
                                    <tr class="optical">
                                        <td>Thông số quang</td>
                                        <td>Quang thông: 475/450lm </td>
                                        <td> Nhiệt độ màu: 3000k</td>
                                        <td> Hệ số màu(CRI): ≥80</td>
                                    </tr>
                                    <tr class="age">
                                        <td>Tuổi thọ</td>
                                        <td>Tuổi thọ đèn: 20.000 giờ</td>
                                        <td>Chu kỳ tắt/bật: 50.000 lần </td>
                                    </tr>
                                    <tr class="consume">
                                        <td>Mức tiêu thụ điện</td>
                                        <td>Mức tiêu thụ điện 1000 giờ: 5kWh</td>
                                        <td></td>
                                    </tr>
                                </table>
<%--                                <p class="text_infor">--%>
...
<%--                                </div>--%>
                                <div class="detail_icon1">
                                    <div class="longevity">
                                        ...
                                        <p class="text_content_detail">Tuổi thọ cao 30000 giờ, độ tin cậy cao, không hạn chế số lần bật/tắt<br>
